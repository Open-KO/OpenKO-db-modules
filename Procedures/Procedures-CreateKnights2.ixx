...
export module Procedure:CreateKnights2;
...
namespace procedure {
	...
	public:
		...
		nanodbc::result* execute(int16_t& nRet, int16_t& index, const uint8_t& nation, const uint8_t& community, const std::string& strName, const std::string& strChief)
		{
