...
namespace model
{
	...
	public:
		...
		static void BindIndex(ItemExchange& m, const nanodbc::result& result, short colIndex)
		{
			result.get_ref<int32_t>(colIndex, m.Index);
		}

		/// \brief Binds a result's column to NpcNumber
		static void BindNpcNumber(ItemExchange& m, const nanodbc::result& result, short colIndex)
		{
