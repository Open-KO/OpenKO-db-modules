...
namespace model
{
	...
	public:
		...
		static void BindIndex(MakeItem& m, const nanodbc::result& result, short colIndex)
		{
		...
		static void BindItemCode(MakeItem& m, const nanodbc::result& result, short colIndex)
		{
			result.get_ref<int32_t>(colIndex, m.ItemCode);
		}

		/// \brief Binds a result's column to ItemLevel
		static void BindItemLevel(MakeItem& m, const nanodbc::result& result, short colIndex)
		{
