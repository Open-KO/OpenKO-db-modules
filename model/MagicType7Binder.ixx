...
namespace model
{
	...
	public:
		...
		static void BindMagicNumber(MagicType7& m, const nanodbc::result& result, short colIndex)
		{
		...
		static void BindMonsterNumber(MagicType7& m, const nanodbc::result& result, short colIndex)
		{
		...
		static void BindHitRate(MagicType7& m, const nanodbc::result& result, short colIndex)
		{
			result.get_ref<int16_t>(colIndex, m.HitRate);
		}

		/// \brief Binds a result's column to Duration
		static void BindDuration(MagicType7& m, const nanodbc::result& result, short colIndex)
		{
			result.get_ref<int16_t>(colIndex, m.Duration);
		}

		/// \brief Binds a result's column to Damage
		static void BindDamage(MagicType7& m, const nanodbc::result& result, short colIndex)
		{
		...
		static void BindNeedItem(MagicType7& m, const nanodbc::result& result, short colIndex)
		{
